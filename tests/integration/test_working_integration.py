# -*- coding: utf-8 -*-
"""Working integration tests for Civitas API - reliable and stable."""
import pytest
from unittest.mock import patch, AsyncMock
import asyncio


class TestCivitasWorkingIntegration:
    """Reliable integration tests that consistently pass."""

    @pytest.mark.asyncio
    async def test_plate_details_success(self, client):
        """Test successful plate details retrieval from external API."""
        plate = "ABC1D34"
    ...
    @pytest.mark.asyncio
    async def test_plate_validation_errors(self, client):
    ...
    @pytest.mark.asyncio
    async def test_cortex_api_integration_flow(self, client):
    ...
    @pytest.mark.asyncio
    async def test_external_api_error_handling(self, client):
        """Test handling of external API errors."""
        plate = "ERROR123"
        
        # Test API returning False (failure) - should return 400 based on actual endpoint behavior
        with patch("app.utils.cortex_request") as mock_cortex:
    ...
    @pytest.mark.asyncio
    async def test_cortex_451_legal_block_handling(self, client):
        """Test 451 Unavailable for Legal Reasons from Cortex."""
        plate = "LEG1234"  # Valid plate format
        
        # Test by mocking cortex_request directly to return 451 response
        class MockResponse:
            status = 451
    ...
    @pytest.mark.asyncio
    async def test_request_validation_comprehensive(self, client):
    ...
    @pytest.mark.asyncio
    async def test_plate_format_edge_cases(self, client):
