#!/usr/bin/env python3
"""
Script para testar o endpoint de PDF em produção
"""
...
def test_prod_pdf():
    """
    Testa o endpoint de PDF em produção
    """
    # URL base de produção
    base_url = "https://api.civitas.rio"
    ...
    print("🔐 Fazendo login em PRODUÇÃO...")
    login_data = {
        "username": username,
        "password": password
    }
    ...
    print(f"✅ Login realizado com sucesso em PRODUÇÃO!")
    print(f"Token: {access_token[:50]}...")
    
    # 2. Testar endpoint de PDF
    print("\n📄 Testando endpoint de PDF em PRODUÇÃO...")
    ...
    if pdf_response.status_code == 200:
        print("✅ PDF gerado com sucesso em PRODUÇÃO!")
        
        # Salvar o arquivo
        with open("prod_pdf_response.zip", "wb") as f:
            f.write(pdf_response.content)
        
        print(f"📁 Arquivo salvo como: prod_pdf_response.zip")
