...
def take_html_screenshot(html_path: str, png_path: str, width: int = 1280, height: int = 800, 
                        only_layers: Optional[List[str]] = None) -> None:
...
def take_html_screenshots_parallel(tasks: List[ScreenshotTask], max_workers: Optional[int] = None) -> dict:
...
def take_html_screenshots_batch(html_paths: List[str], png_paths: List[str], 
...
def take_html_screenshot_legacy(html_path: str, png_path: str, width: int = 1280, height: int = 800, 
                               only_layers: Optional[List[str]] = None) -> None:
