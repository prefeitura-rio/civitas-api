...
def generate_map_clonagem_single_day_html(df_pairs: pd.DataFrame, use_clusters: bool = True, vmax_kmh: float = VMAX_KMH) -> str:
    ...
    if df_pairs is None or df_pairs.empty:
        return generate_map_clonagem(df_pairs, use_clusters=use_clusters, vmax_kmh=vmax_kmh)
    ...
    return generate_map_clonagem(df[df["_day_str"] == first_day].copy(), use_clusters=use_clusters, vmax_kmh=vmax_kmh)