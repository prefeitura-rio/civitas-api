...
class PDFLayoutManager:
    ...
    def _calculate_logo_positions(self, layout):
        ...
        x_logo_start = layout['margin'] + (layout['col1_width'] - (prefeitura_w + civitas_w + logo_spacing)) / 2
    ...
    def _place_logos(self, prefeitura_path, civitas_path, pos):
        """Place logos on PDF"""
        self.pdf.image(prefeitura_path, x=pos['x_start'], y=pos['y_start'], w=pos['prefeitura_w'])
        self.pdf.image(civitas_path, x=pos['x_start'] + pos['prefeitura_w'] + pos['spacing'], 
                      y=pos['y_start'], w=pos['civitas_w'])
    ...
    def _advance_cursor(self, layout):
        ...
        self.pdf.set_y(layout['y_start'] + layout['row1_height'] + layout['row2_height'] + 5)
