...
class DetectionRepositoryFactory:
    ...
    @staticmethod
    def create_bigquery_repository(project_id: str, credentials_path: Optional[str] = None) -> BigQueryDetectionRepository:
        """Create production BigQuery repository"""
        return BigQueryDetectionRepository(project_id=project_id, credentials_path=credentials_path)
    
    @staticmethod
    def create_csv_repository(data_directory: str = "dados_placas") -> CSVDetectionRepository:
