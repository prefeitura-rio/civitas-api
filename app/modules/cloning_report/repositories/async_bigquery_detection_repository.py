...
from ..data.query_builder import BigQueryQueryBuilder, QueryParameters
...
class AsyncBigQueryDetectionRepository(DetectionRepository):
    ...
    async def find_by_plate_and_period(self, plate: str, start_date: datetime, end_date: datetime) -> List[Detection]:
...
class AsyncDetectionRepositoryFactory:
    ...
    @staticmethod
    def create_async_bigquery_repository(executor: Optional[ThreadPoolExecutor] = None) -> AsyncBigQueryDetectionRepository:
