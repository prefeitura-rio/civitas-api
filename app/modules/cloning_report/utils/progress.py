...
class ProgressTracker:
    ...
    def __init__(self, callback: Optional[Callable[[TaskProgress], None]] = None):
    ...
    def update_progress(self, task_id: str, percent: float, message: str, 
...
class ScreenshotProgressTracker(ProgressTracker):
    ...
    def screenshot_completed(self, task_id: str, screenshot_name: str, 
        ...
        self.screenshot_stats['avg_time'] = (prev_avg * (completed - 1) + time_taken) / completed
    ...
    def screenshot_failed(self, task_id: str, screenshot_name: str, 
                         error: str) -> None:
