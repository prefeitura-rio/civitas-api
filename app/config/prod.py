...
# feature flags
ENABLE_GCS_ENDPOINTS = (
    getenv_or_action("ENABLE_GCS_ENDPOINTS", default="false").lower() == "true"
)
ENABLE_CLONING_REPORT_ENDPOINT = (
    getenv_or_action("ENABLE_CLONING_REPORT_ENDPOINT", default="false").lower()
    == "true"
)

ENABLE_NEW_RADAR_LIST_ENDPOINT = (
    getenv_or_action("ENABLE_NEW_RADAR_LIST_ENDPOINT", default="true").lower() == "true"
)
GCS_BUCKET_NAME = getenv_or_action("GCS_BUCKET_NAME")
